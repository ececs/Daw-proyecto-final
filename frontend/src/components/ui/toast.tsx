...
>(({ className, ...props }, ref) => {
  ...
  return (
    <ToastPrimitives.Viewport
      ref={ref}
      className={cn(
        "fixed bottom-0 left-0 z-[150] flex w-full max-w-full flex-col gap-2 p-3 sm:bottom-0 sm:right-0 sm:left-auto sm:max-w-[420px] sm:p-4 transition-all duration-300",
        isChatOpen && "sm:right-[400px]",
        className
      )}
      {...props}
    />
...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-4 pr-8 shadow-lg transition-all data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-bottom-full sm:p-6",
  {
    variants: {
      variant: {
